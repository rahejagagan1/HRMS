...
import { wfhDayWeight } from "@/lib/hr/wfh-day-kind";

// The pure day-kind helpers moved to wfh-day-kind.ts (client-safe — this
// module imports prisma, which fail-fasts in a browser bundle). Re-exported
// here so existing server-side imports keep working unchanged; CLIENT
// components must import from "@/lib/hr/wfh-day-kind" directly.
export {
  WFH_HALF_DAY_RE, wfhDayWeight, wfhSegment, wfhDayKind,
  isFullDayWfh, wfhKindLabel, wfhKindTitle,
} from "@/lib/hr/wfh-day-kind";
export type { WfhSegment, WfhDayKind } from "@/lib/hr/wfh-day-kind";
